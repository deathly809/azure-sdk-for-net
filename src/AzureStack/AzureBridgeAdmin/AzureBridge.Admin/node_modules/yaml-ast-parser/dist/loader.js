...
function generateError(state, message) {
    return new exception_1.YAMLException(message, new Mark(state.filename, state.input, state.position, state.line - 1, (state.position - state.lineStart)));
}
function throwErrorFromPosition(state, position, message) {
    ...
    var error = new exception_1.YAMLException(message, mark);
...
function load(input, options) {
    ...
    var e = new exception_1.YAMLException('expected a single document in the stream, but found more');
