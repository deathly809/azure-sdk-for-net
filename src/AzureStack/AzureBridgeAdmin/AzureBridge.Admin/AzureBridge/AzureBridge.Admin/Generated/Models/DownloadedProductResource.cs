...
namespace Microsoft.AzureStack.Management.AzureBridge.Admin.Models
{
    ...
    public partial class DownloadedProductResource : Resource
    {
        ...
        /// <param name="galleryItemIdentity">Identity in the gallary.</param>
        ...
        public DownloadedProductResource(string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string displayName = default(string), string description = default(string), string publisherDisplayName = default(string), string publisherIdentifier = default(string), string provisioningState = default(string), string offer = default(string), string offerVersion = default(string), string sku = default(string), string billingPartNumber = default(string), string vmExtensionType = default(string), string galleryItemIdentity = default(string), string iconUris = default(string), IList<ProductLink> links = default(IList<ProductLink>), string legalTerms = default(string), string privacyPolicy = default(string), long? payloadLength = default(long?), string productKind = default(string), string productProperties = default(string))
        ...
        /// <summary>
        /// Gets or sets identity in the gallary.
        /// </summary>
