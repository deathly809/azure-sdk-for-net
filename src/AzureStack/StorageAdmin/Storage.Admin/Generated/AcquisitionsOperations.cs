...
namespace Microsoft.AzureStack.Management.Storage.Admin
{
    ...
    internal partial class AcquisitionsOperations : IServiceOperations<StorageAdminClient>, IAcquisitionsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<Acquisition>> GetWithHttpMessagesAsync(string resourceGroupName, string farmId, string acquisitionId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "acquisitionId");
            }
            ...
            _url = _url.Replace("{acquisitionId}", System.Uri.EscapeDataString(acquisitionId));
