...
namespace Microsoft.AzureStack.Management.Storage.Admin
{
    ...
    internal partial class ContainersOperations : IServiceOperations<StorageAdminClient>, IContainersOperations
    {
        ...
        {
            // Send request
            AzureOperationResponse<string> _response = await BeginMigrateWithHttpMessagesAsync(resourceGroupName, farmId, shareName, intent, maxCount, startIndex, migrationParameters, customHeaders, cancellationToken).ConfigureAwait(false);
            return await Client.GetPostOrDeleteOperationResultAsync(_response, customHeaders, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<string>> BeginMigrateWithHttpMessagesAsync(string resourceGroupName, string farmId, string shareName, string intent, int maxCount, int startIndex, MigrationParameters migrationParameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IList<Share>>> ListDestinationSharesNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
