...
namespace Microsoft.AzureStack.Management.Storage.Admin
{
    ...
    public static partial class QueuesOperationsExtensions
    {
            ...
            /// </param>
            public static QueueServiceResource Get(this IQueuesOperations operations, string resourceGroupName, string farmId)
            {
            ...
            /// </param>
            public static async Task<QueueServiceResource> GetAsync(this IQueuesOperations operations, string resourceGroupName, string farmId, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static IPage<MetricDefinition> ListMetricDefinitions(this IQueuesOperations operations, string resourceGroupName, string farmId, ODataQuery<MetricDefinition> odataQuery = default(ODataQuery<MetricDefinition>))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<MetricDefinition>> ListMetricDefinitionsAsync(this IQueuesOperations operations, string resourceGroupName, string farmId, ODataQuery<MetricDefinition> odataQuery = default(ODataQuery<MetricDefinition>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// OData parameters to apply to the operation.
            /// </param>
            public static IPage<Metric> ListMetrics(this IQueuesOperations operations, string resourceGroupName, string farmId, ODataQuery<Metric> odataQuery = default(ODataQuery<Metric>))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<Metric>> ListMetricsAsync(this IQueuesOperations operations, string resourceGroupName, string farmId, ODataQuery<Metric> odataQuery = default(ODataQuery<Metric>), CancellationToken cancellationToken = default(CancellationToken))
            {
