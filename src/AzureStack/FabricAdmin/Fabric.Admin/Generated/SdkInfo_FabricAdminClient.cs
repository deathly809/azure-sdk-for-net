    ...
    public static IEnumerable<Tuple<string, string, string>> ApiInfo_FabricAdminClient
    {
        get
        {
            return new Tuple<string, string, string>[]
            {
                ...
                new Tuple<string, string, string>("FabricAdminClient", "ComputeFabricOperations", "2016-05-01"),
                new Tuple<string, string, string>("FabricAdminClient", "NetworkFabricOperations", "2016-05-01"),
            }.AsEnumerable();
        }
    }
}
