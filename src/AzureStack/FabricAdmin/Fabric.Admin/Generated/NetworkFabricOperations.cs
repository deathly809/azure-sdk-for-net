...
namespace Microsoft.AzureStack.Management.Fabric.Admin
{
    ...
    internal partial class NetworkFabricOperations : IServiceOperations<FabricAdminClient>, INetworkFabricOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse> GetWithHttpMessagesAsync(string resourceGroupName, string location, string provider, string networkOperationResult, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{provider}/fabricLocations/{location}/networkOperationResults/{networkOperationResult}").ToString();
