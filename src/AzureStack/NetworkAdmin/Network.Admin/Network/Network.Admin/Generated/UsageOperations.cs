...
namespace Microsoft.AzureStack.Management.Network.Admin
{
    ...
    internal partial class UsageOperations : IServiceOperations<NetworkAdminClient>, IUsageOperations
    {
        ...
        public async Task<AzureOperationResponse<IList<UsageMeterProperty>>> ListWithHttpMessagesAsync(string location, string filter = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/Microsoft.Network.Admin/locations/{location}/meters").ToString();
