...
namespace Microsoft.AzureStack.Management.Network.Admin
{
    ...
    public partial class NetworkAdminClient : ServiceClient<NetworkAdminClient>, INetworkAdminClient, IAzureClient
    {
        ...
        /// </summary>
        public virtual IOverviewOperations Overview { get; private set; }

        /// <summary>
        /// Gets the IRotateEncryptionCertificateOperations.
        /// </summary>
        public virtual IRotateEncryptionCertificateOperations RotateEncryptionCertificate { get; private set; }
        ...
        {
            Overview = new OverviewOperations(this);
